...
function BriefIndex(){     
    ...
    useEffect(()=>{
        try{  
             // 重置默认的序号
             let liArr = document.querySelectorAll(".ant-steps .ant-steps-item .ant-steps-icon");
        ...
        <div id='platform-body'  >  
            <div className='platform-inner-body'> 
                <div id='useversion-div' className='theme-box'> 
                    <h1 align="center" className='user-title theme-box-txt'> <span>版本更新</span>   </h1>
                    <div className='mybody-div'>  
                        <Steps direction="vertical" >  
                            <Step title="版本1.1.1" description={
                                <ul  >
                                    <li>1.解决云平台删除普通用户的异常</li>
                                    <li>2.完善管理员添加功能，需要输入密码验证，有强密码注册限制</li>
                                    <li>3.完善普通用户不能修改水雨情数据的需求</li>  
                                </ul>
                            }/>
                            <Step title="版本1.1.0" description={
                                <ul  >
                                    <li>1.完成水雨情系统历史搜索</li>
                            ...
                            <Step title="版本1.0.5" data-height="200" description={
                                <ul  >
                                    <li>1.优化登录面板</li>
                                    <li>2.修改密码添加安全认证</li>
                                    <li>3.更好适应移动端的高度</li> 
                            ...
                            <Step title="版本1.0.4" description={
                                <ul  >
                                    <li>1.新添加登录页的验证码</li>
                                    <li>2.优化加载页面的旋转器</li>
                            ...
                            <Step title="版本1.0.3" description={
                                <ul  >
                                    <li>1.新添加登录页的验证码</li>
                                    <li>2.优化加载页面的旋转器</li>
                                    <li>3.优化后退设置，更加清晰的后退逻辑</li>  
                            ...
                            <Step title="版本1.0.2" description={
                                <ul  >
                                    <li>1.优化移动端退出问题</li>
                                    <li>2.解决主页云平台，对官网数据获取的问题</li> 
                                </ul>
                            }/>
                            <Step title="版本1.0.1" description={
                                <ul  >
                                    <li>1.风格改版，云平台替换成星空背景，荧光色彩</li>
                                    <li>2.水雨情添加未完成的数据处理模块（暂未对应接口数据）</li> 
                                </ul>
                            }/>

                            <Step title="版本1.0.0" description={
                                <ul  >
